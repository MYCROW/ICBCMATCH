...
import com.example.crow.goldsupplychainapp.network.HttpURLConnectionNetworkTask;
import com.example.crow.goldsupplychainapp.network.NetworkTask;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private String key = "";
    private Boolean hasVaildcode = false;
    /**
        ...
        networkTask.setResponseListener(new NetworkTask.ResponseListener() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    vaildcode = json.getJSONObject("data").getString("login_validCode");
            ...
            public void onError(String error) {
                Toast.makeText(mContext,"Network Error:"+error, Toast.LENGTH_SHORT);
            }
        });
    }
...
//        return password.length() > 2;
     ...
     * the user.
     */
    public class UserLoginTask extends HttpURLConnectionNetworkTask{
        public final String TAG = "UserLoginTask";
...
//        }
        ...
        void execute(Void v) {
            if (hasVaildcode) {
                super.execute("https://www.cjtellyou.xyz/chainblock/user/login",
                        "email=" + mEmail,
                        "passwd=" + mPassword,
                        "validCode=" + vaildcode,
                        "key=" + key);
